...
export class ScaleOrientationManager {
    constructor(map) {
        ...
        this.initOrientation(); // ✅ Initialisé en premier pour être en haut
        this.initScale(); // ✅ Initialisé en second pour être en dessous (si même position)
    }
    ...
    initScale() {
        ...
        const scaleOptions = {
            position: 'topright', // ✅ Déplacé à droite sous la rose des vents
            maxWidth: 150, // Largeur maximale ajustée pour mobile
    ...
    initOrientation() {
        const OrientationControl = L.Control.extend({
            options: {
                position: 'topright' // ✅ Déplacé en haut à droite à côté du titre
            },
