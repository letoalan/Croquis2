...
export class ContextMenuDragger {
    ...
    /**
     * ✅ Affiche le menu près d'un point spécifique (magnétique)
     */
    showNear(x, y) {
        if (!this.contextMenu) return;

        // Positionner à côté du point (ex: décalage de 40px pour ne pas masquer le point)
        const offset = 40;
        let left = x + offset;
        let top = y;

        // Appliquer temporairement pour mesurer
        ...
        console.log(`[ContextMenuDragger] Magnetic show at: ${x}, ${y}`);
    }
}