# 📁 Dossier : `fportrait/js`

**Fil d'Ariane :** [🏠 Wiki Central](../../index.md) / [Dossier Parent (fportrait)](../index.md) / `fportrait/js`
...
Version de l'application adaptée aux terminaux mobiles et tablettes (format Portrait).
...
| :--- | :--- | :--- |
| `/modules` | Gestionnaires d'état et d'interface pour le format mobile/portrait. | [Accéder au dossier (modules)](modules/index.md) |
