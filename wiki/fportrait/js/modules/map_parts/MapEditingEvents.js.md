...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fportrait/js/modules/map_parts](index.md) / `MapEditingEvents.js`
...
> - **Code Source Réel :** [💻 Voir `MapEditingEvents.js`](../../../../../fportrait/js/modules/map_parts/MapEditingEvents.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (MapEditingEvents.js) composant le module fportrait/js/modules/map_parts.

### Métadonnées Techniques
- **Emplacement relatif :** `fportrait/js/modules/map_parts/MapEditingEvents.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (MapEditingEvents.js)](../../../../../fportrait/js/modules/map_parts/MapEditingEvents.js)