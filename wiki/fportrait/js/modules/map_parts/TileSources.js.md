# 📄 Fiche Documentaire : `TileSources.js`

**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fportrait/js/modules/map_parts](index.md) / `TileSources.js`

> **Interconnexions :**
> - **Dossier Parent :** [fportrait/js/modules/map_parts](index.md)
> - **Documentation Technique Globale :** [🗺️ projet.md](../../../../../projet.md)
> - **Portail Wiki :** [📚 Wiki Central](../../../../index.md)
> - **Code Source Réel :** [💻 Voir `TileSources.js`](../../../../../fportrait/js/modules/map_parts/TileSources.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (TileSources.js) composant le module fportrait/js/modules/map_parts.

### Métadonnées Techniques
- **Emplacement relatif :** `fportrait/js/modules/map_parts/TileSources.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 1.12 Ko (1147 octets)
- **Nombre de lignes :** 32 lignes
...
- [📁 Consulter l'index du dossier (fportrait/js/modules/map_parts)](index.md)
- [🗺️ Consulter la documentation d'architecture globale (projet.md)](../../../../../projet.md)
- [📚 Revenir à l'accueil du Wiki Central](../../../../index.md)
- [💻 Ouvrir le code source (TileSources.js)](../../../../../fportrait/js/modules/map_parts/TileSources.js)