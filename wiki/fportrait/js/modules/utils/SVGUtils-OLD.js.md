...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fportrait/js/modules/utils](index.md) / `SVGUtils-OLD.js`
...
> - **Code Source Réel :** [💻 Voir `SVGUtils-OLD.js`](../../../../../fportrait/js/modules/utils/SVGUtils-OLD.js)
...
- **Emplacement relatif :** `fportrait/js/modules/utils/SVGUtils-OLD.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (SVGUtils-OLD.js)](../../../../../fportrait/js/modules/utils/SVGUtils-OLD.js)