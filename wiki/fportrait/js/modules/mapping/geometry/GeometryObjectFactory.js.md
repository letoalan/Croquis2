...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/geometry](index.md) / `GeometryObjectFactory.js`
...
> - **Code Source Réel :** [💻 Voir `GeometryObjectFactory.js`](../../../../../../fportrait/js/modules/mapping/geometry/GeometryObjectFactory.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (GeometryObjectFactory.js) composant le module fportrait/js/modules/mapping/geometry.

### Métadonnées Techniques
- **Emplacement relatif :** `fportrait/js/modules/mapping/geometry/GeometryObjectFactory.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (GeometryObjectFactory.js)](../../../../../../fportrait/js/modules/mapping/geometry/GeometryObjectFactory.js)