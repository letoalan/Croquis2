...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/io](index.md) / `ExportImportManager.js`
...
> - **Code Source Réel :** [💻 Voir `ExportImportManager.js`](../../../../../../fportrait/js/modules/mapping/io/ExportImportManager.js)
...
- **Emplacement relatif :** `fportrait/js/modules/mapping/io/ExportImportManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (ExportImportManager.js)](../../../../../../fportrait/js/modules/mapping/io/ExportImportManager.js)