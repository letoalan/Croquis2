...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/legend](index.md) / `LegendManager.js`
...
> - **Code Source Réel :** [💻 Voir `LegendManager.js`](../../../../../../fportrait/js/modules/mapping/legend/LegendManager.js)
...
- **Emplacement relatif :** `fportrait/js/modules/mapping/legend/LegendManager.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 57.67 Ko (59057 octets)
...
- [💻 Ouvrir le code source (LegendManager.js)](../../../../../../fportrait/js/modules/mapping/legend/LegendManager.js)