# 📄 Fiche Documentaire : `LegendOrganizer.js`

**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/legend](index.md) / `LegendOrganizer.js`
...
> - **Code Source Réel :** [💻 Voir `LegendOrganizer.js`](../../../../../../fportrait/js/modules/mapping/legend/LegendOrganizer.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Gestionnaire de glisser-déposer (Drag & Drop) pour la réorganisation interactive de la hiérarchie de la légende.

### Métadonnées Techniques
- **Emplacement relatif :** `fportrait/js/modules/mapping/legend/LegendOrganizer.js`
- **Type de fichier :** `.js`
...
### Classes Définies
- `class LegendOrganizer` : Cœur du composant responsable de la logique métier associée.
...
- [💻 Ouvrir le code source (LegendOrganizer.js)](../../../../../../fportrait/js/modules/mapping/legend/LegendOrganizer.js)