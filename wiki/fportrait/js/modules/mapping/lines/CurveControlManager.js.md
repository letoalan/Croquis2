...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/lines](index.md) / `CurveControlManager.js`
...
> - **Code Source Réel :** [💻 Voir `CurveControlManager.js`](../../../../../../fportrait/js/modules/mapping/lines/CurveControlManager.js)
...
- **Emplacement relatif :** `fportrait/js/modules/mapping/lines/CurveControlManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (CurveControlManager.js)](../../../../../../fportrait/js/modules/mapping/lines/CurveControlManager.js)