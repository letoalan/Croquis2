...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fportrait/js/modules/mapping/lines](index.md) / `LineControlManager.js`
...
> - **Code Source Réel :** [💻 Voir `LineControlManager.js`](../../../../../../fportrait/js/modules/mapping/lines/LineControlManager.js)
...
- **Emplacement relatif :** `fportrait/js/modules/mapping/lines/LineControlManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (LineControlManager.js)](../../../../../../fportrait/js/modules/mapping/lines/LineControlManager.js)