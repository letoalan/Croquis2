...
**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fportrait/js/modules](index.md) / `GeometryManager.js`
...
> - **Code Source Réel :** [💻 Voir `GeometryManager.js`](../../../../fportrait/js/modules/GeometryManager.js)
...
- **Emplacement relatif :** `fportrait/js/modules/GeometryManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (GeometryManager.js)](../../../../fportrait/js/modules/GeometryManager.js)