# 📄 Fiche Documentaire : `_sidebar.css`

**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fportrait/css/components](index.md) / `_sidebar.css`
...
> - **Code Source Réel :** [💻 Voir `_sidebar.css`](../../../../fportrait/css/components/_sidebar.css)
...
- **Emplacement relatif :** `fportrait/css/components/_sidebar.css`
- **Type de fichier :** `.css`
- **Poids du fichier :** 4.09 Ko (4185 octets)
- **Nombre de lignes :** 171 lignes
...
- [💻 Ouvrir le code source (_sidebar.css)](../../../../fportrait/css/components/_sidebar.css)