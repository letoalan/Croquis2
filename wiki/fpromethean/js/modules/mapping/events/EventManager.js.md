...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpromethean/js/modules/mapping/events](index.md) / `EventManager.js`
...
> - **Code Source Réel :** [💻 Voir `EventManager.js`](../../../../../../fpromethean/js/modules/mapping/events/EventManager.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/mapping/events/EventManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (EventManager.js)](../../../../../../fpromethean/js/modules/mapping/events/EventManager.js)