...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpromethean/js/modules/mapping/io](index.md) / `PDFExporter.js`

> **Interconnexions :**
> - **Dossier Parent :** [fpromethean/js/modules/mapping/io](index.md)
> - **Documentation Technique Globale :** [🗺️ projet.md](../../../../../../projet.md)
> - **Portail Wiki :** [📚 Wiki Central](../../../../../index.md)
> - **Code Source Réel :** [💻 Voir `PDFExporter.js`](../../../../../../fpromethean/js/modules/mapping/io/PDFExporter.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/mapping/io/PDFExporter.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 32.49 Ko (33267 octets)
- **Nombre de lignes :** 663 lignes
...
- [📁 Consulter l'index du dossier (fpromethean/js/modules/mapping/io)](index.md)
- [🗺️ Consulter la documentation d'architecture globale (projet.md)](../../../../../../projet.md)
- [📚 Revenir à l'accueil du Wiki Central](../../../../../index.md)
- [💻 Ouvrir le code source (PDFExporter.js)](../../../../../../fpromethean/js/modules/mapping/io/PDFExporter.js)