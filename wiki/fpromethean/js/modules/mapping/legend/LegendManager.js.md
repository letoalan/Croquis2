...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpromethean/js/modules/mapping/legend](index.md) / `LegendManager.js`
...
> - **Code Source Réel :** [💻 Voir `LegendManager.js`](../../../../../../fpromethean/js/modules/mapping/legend/LegendManager.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/mapping/legend/LegendManager.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 57.02 Ko (58384 octets)
- **Nombre de lignes :** 1333 lignes
...
- [💻 Ouvrir le code source (LegendManager.js)](../../../../../../fpromethean/js/modules/mapping/legend/LegendManager.js)