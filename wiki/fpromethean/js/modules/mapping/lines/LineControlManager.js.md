...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpromethean/js/modules/mapping/lines](index.md) / `LineControlManager.js`

> **Interconnexions :**
> - **Dossier Parent :** [fpromethean/js/modules/mapping/lines](index.md)
> - **Documentation Technique Globale :** [🗺️ projet.md](../../../../../../projet.md)
> - **Portail Wiki :** [📚 Wiki Central](../../../../../index.md)
> - **Code Source Réel :** [💻 Voir `LineControlManager.js`](../../../../../../fpromethean/js/modules/mapping/lines/LineControlManager.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/mapping/lines/LineControlManager.js`
- **Type de fichier :** `.js`
...
- [📁 Consulter l'index du dossier (fpromethean/js/modules/mapping/lines)](index.md)
- [🗺️ Consulter la documentation d'architecture globale (projet.md)](../../../../../../projet.md)
- [📚 Revenir à l'accueil du Wiki Central](../../../../../index.md)
- [💻 Ouvrir le code source (LineControlManager.js)](../../../../../../fpromethean/js/modules/mapping/lines/LineControlManager.js)