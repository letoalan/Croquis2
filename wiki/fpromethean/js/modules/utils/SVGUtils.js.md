...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fpromethean/js/modules/utils](index.md) / `SVGUtils.js`
...
> - **Code Source Réel :** [💻 Voir `SVGUtils.js`](../../../../../fpromethean/js/modules/utils/SVGUtils.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/utils/SVGUtils.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 43.1 Ko (44136 octets)
- **Nombre de lignes :** 1072 lignes
...
- [💻 Ouvrir le code source (SVGUtils.js)](../../../../../fpromethean/js/modules/utils/SVGUtils.js)