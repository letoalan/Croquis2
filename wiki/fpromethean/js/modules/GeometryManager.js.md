...
**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpromethean/js/modules](index.md) / `GeometryManager.js`
...
> - **Code Source Réel :** [💻 Voir `GeometryManager.js`](../../../../fpromethean/js/modules/GeometryManager.js)
...
- **Emplacement relatif :** `fpromethean/js/modules/GeometryManager.js`
- **Type de fichier :** `.js`
- **Poids du fichier :** 5.53 Ko (5666 octets)
- **Nombre de lignes :** 140 lignes
...
| `./PointerRouter.js` | `PointerRouter` |
...
- [💻 Ouvrir le code source (GeometryManager.js)](../../../../fpromethean/js/modules/GeometryManager.js)