...
**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpromethean/js/modules](index.md) / `StateManager.js`
...
> - **Code Source Réel :** [💻 Voir `StateManager.js`](../../../../fpromethean/js/modules/StateManager.js)
...
- [💻 Ouvrir le code source (StateManager.js)](../../../../fpromethean/js/modules/StateManager.js)