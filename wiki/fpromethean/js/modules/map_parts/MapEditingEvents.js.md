...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fpromethean/js/modules/map_parts](index.md) / `MapEditingEvents.js`

> **Interconnexions :**
> - **Dossier Parent :** [fpromethean/js/modules/map_parts](index.md)
> - **Documentation Technique Globale :** [🗺️ projet.md](../../../../../projet.md)
> - **Portail Wiki :** [📚 Wiki Central](../../../../index.md)
> - **Code Source Réel :** [💻 Voir `MapEditingEvents.js`](../../../../../fpromethean/js/modules/map_parts/MapEditingEvents.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (MapEditingEvents.js) composant le module fpromethean/js/modules/map_parts.

### Métadonnées Techniques
- **Emplacement relatif :** `fpromethean/js/modules/map_parts/MapEditingEvents.js`
- **Type de fichier :** `.js`
...
- [📁 Consulter l'index du dossier (fpromethean/js/modules/map_parts)](index.md)
- [🗺️ Consulter la documentation d'architecture globale (projet.md)](../../../../../projet.md)
- [📚 Revenir à l'accueil du Wiki Central](../../../../index.md)
- [💻 Ouvrir le code source (MapEditingEvents.js)](../../../../../fpromethean/js/modules/map_parts/MapEditingEvents.js)