# 📄 Fiche Documentaire : `_variables.css`

**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpromethean/css/base](index.md) / `_variables.css`

> **Interconnexions :**
> - **Dossier Parent :** [fpromethean/css/base](index.md)
> - **Documentation Technique Globale :** [🗺️ projet.md](../../../../projet.md)
> - **Portail Wiki :** [📚 Wiki Central](../../../index.md)
> - **Code Source Réel :** [💻 Voir `_variables.css`](../../../../fpromethean/css/base/_variables.css)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Définition des variables de thème CSS (couleurs, gradients, typographie, espacements et ombrages globaux).

### Métadonnées Techniques
- **Emplacement relatif :** `fpromethean/css/base/_variables.css`
- **Type de fichier :** `.css`
- **Poids du fichier :** 2.85 Ko (2914 octets)
...
- [📁 Consulter l'index du dossier (fpromethean/css/base)](index.md)
- [🗺️ Consulter la documentation d'architecture globale (projet.md)](../../../../projet.md)
- [📚 Revenir à l'accueil du Wiki Central](../../../index.md)
- [💻 Ouvrir le code source (_variables.css)](../../../../fpromethean/css/base/_variables.css)