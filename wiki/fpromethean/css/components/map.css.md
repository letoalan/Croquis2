# 📄 Fiche Documentaire : `map.css`

**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpromethean/css/components](index.md) / `map.css`
...
> - **Code Source Réel :** [💻 Voir `map.css`](../../../../fpromethean/css/components/map.css)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Règles d'intégration et conteneur de la carte Leaflet, curseurs de dessin et éléments superposés.

### Métadonnées Techniques
- **Emplacement relatif :** `fpromethean/css/components/map.css`
- **Type de fichier :** `.css`
- **Poids du fichier :** 3.45 Ko (3531 octets)
- **Nombre de lignes :** 153 lignes
...
- [💻 Ouvrir le code source (map.css)](../../../../fpromethean/css/components/map.css)