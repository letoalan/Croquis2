# 📄 Fiche Documentaire : `sidebar.css`

**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpromethean/css/components](index.md) / `sidebar.css`
...
> - **Code Source Réel :** [💻 Voir `sidebar.css`](../../../../fpromethean/css/components/sidebar.css)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Styles des barres latérales d'outils, accordéons de fonctionnalités et conteneurs de navigation.

### Métadonnées Techniques
- **Emplacement relatif :** `fpromethean/css/components/sidebar.css`
- **Type de fichier :** `.css`
- **Poids du fichier :** 4.25 Ko (4352 octets)
- **Nombre de lignes :** 173 lignes
...
- `.sidebar-toggle-left .toggle-icon`
...
- [💻 Ouvrir le code source (sidebar.css)](../../../../fpromethean/css/components/sidebar.css)