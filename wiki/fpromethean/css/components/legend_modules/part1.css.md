...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fpromethean/css/components/legend_modules](index.md) / `part1.css`
...
> - **Code Source Réel :** [💻 Voir `part1.css`](../../../../../fpromethean/css/components/legend_modules/part1.css)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (part1.css) composant le module fpromethean/css/components/legend_modules.

### Métadonnées Techniques
- **Emplacement relatif :** `fpromethean/css/components/legend_modules/part1.css`
- **Type de fichier :** `.css`
- **Poids du fichier :** 4.21 Ko (4309 octets)
...
- [💻 Ouvrir le code source (part1.css)](../../../../../fpromethean/css/components/legend_modules/part1.css)