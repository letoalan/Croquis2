...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../index.md) / [📁 Dossier fpaysage/js/modules/map_parts](index.md) / `TileSources.js`
...
> - **Code Source Réel :** [💻 Voir `TileSources.js`](../../../../../fpaysage/js/modules/map_parts/TileSources.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (TileSources.js) composant le module fpaysage/js/modules/map_parts.

### Métadonnées Techniques
- **Emplacement relatif :** `fpaysage/js/modules/map_parts/TileSources.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (TileSources.js)](../../../../../fpaysage/js/modules/map_parts/TileSources.js)