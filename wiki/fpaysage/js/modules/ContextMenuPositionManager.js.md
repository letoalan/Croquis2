...
**Fil d'Ariane :** [🏠 Wiki Central](../../../index.md) / [📁 Dossier fpaysage/js/modules](index.md) / `ContextMenuPositionManager.js`
...
> - **Code Source Réel :** [💻 Voir `ContextMenuPositionManager.js`](../../../../fpaysage/js/modules/ContextMenuPositionManager.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (ContextMenuPositionManager.js) composant le module fpaysage/js/modules.

### Métadonnées Techniques
- **Emplacement relatif :** `fpaysage/js/modules/ContextMenuPositionManager.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (ContextMenuPositionManager.js)](../../../../fpaysage/js/modules/ContextMenuPositionManager.js)