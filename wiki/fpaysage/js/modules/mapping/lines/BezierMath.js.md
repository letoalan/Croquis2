...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpaysage/js/modules/mapping/lines](index.md) / `BezierMath.js`
...
> - **Code Source Réel :** [💻 Voir `BezierMath.js`](../../../../../../fpaysage/js/modules/mapping/lines/BezierMath.js)

---

## 1. Vue d'Ensemble et Rôle
**Description fonctionnelle :**  
Fichier technique (BezierMath.js) composant le module fpaysage/js/modules/mapping/lines.

### Métadonnées Techniques
- **Emplacement relatif :** `fpaysage/js/modules/mapping/lines/BezierMath.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (BezierMath.js)](../../../../../../fpaysage/js/modules/mapping/lines/BezierMath.js)