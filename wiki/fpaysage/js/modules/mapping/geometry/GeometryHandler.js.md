...
**Fil d'Ariane :** [🏠 Wiki Central](../../../../../index.md) / [📁 Dossier fpaysage/js/modules/mapping/geometry](index.md) / `GeometryHandler.js`
...
> - **Code Source Réel :** [💻 Voir `GeometryHandler.js`](../../../../../../fpaysage/js/modules/mapping/geometry/GeometryHandler.js)
...
- **Emplacement relatif :** `fpaysage/js/modules/mapping/geometry/GeometryHandler.js`
- **Type de fichier :** `.js`
...
- [💻 Ouvrir le code source (GeometryHandler.js)](../../../../../../fpaysage/js/modules/mapping/geometry/GeometryHandler.js)